...
window.addEventListener('DOMContentLoaded', function () {
  "use strict"; // инициализация объекта начального состояния модальных окон в калькуляторе

  var modalState = {}; // дедлайн для Акции
...
/* harmony import */ var _validate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validate */ "./src/js/modules/validate.js");



var changeModalState = function changeModalState(state) {
  var windowFormFactor = document.querySelectorAll('.balcon_icons_img'),
      windowWidth = document.querySelectorAll('#width'),
      windowHeight = document.querySelectorAll('#height'),
      windowType = document.querySelectorAll('#view_type'),
      windowProfile = document.querySelectorAll('.checkbox');
  Object(_validate__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
  Object(_validate__WEBPACK_IMPORTED_MODULE_1__["default"])('#height');

  var bindActionToElements = function bindActionToElements(event, elem, property) {
...
/* harmony import */ var _validate__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./validate */ "./src/js/modules/validate.js");
...
var forms = function forms(state) {
  ...
  Object(_validate__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]');
  var message = {
    loading: 'Загрузка',
...
var timer = function timer(id, deadline) {
  // добавляет 0 перед числами 0..9 в таймере
  ...
  var getTimeRemaining = function getTimeRemaining(endtime) {
    // разница между дедлайном и текущим временем в мс
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    updateClock(); // функция определяет сколько времени осталось до дедлайна      
    ...
    function updateClock() {
      ...
      if (time.total <= 0) {
        // если дедлайн наступил, выставляем все по 0
        days.textContent = '00';
...
var validateInputs = function validateInputs(selector) {
  var numberInputs = document.querySelectorAll(selector);
